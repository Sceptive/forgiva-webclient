...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostUserSettingsSetRequest();
  });
  ...
  describe('PostUserSettingsSetRequest', function() {
    it('should create an instance of PostUserSettingsSetRequest', function() {
      // uncomment below and update the code to test PostUserSettingsSetRequest
      //var instane = new IntegratorApi.PostUserSettingsSetRequest();
      //expect(instance).to.be.a(IntegratorApi.PostUserSettingsSetRequest);
    });
