...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostUserMetadataSearchRequest();
  });
  ...
  describe('PostUserMetadataSearchRequest', function() {
    it('should create an instance of PostUserMetadataSearchRequest', function() {
      // uncomment below and update the code to test PostUserMetadataSearchRequest
      //var instane = new IntegratorApi.PostUserMetadataSearchRequest();
      //expect(instance).to.be.a(IntegratorApi.PostUserMetadataSearchRequest);
    });
