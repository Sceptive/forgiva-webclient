...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.LogonState();
  });
  ...
  describe('LogonState', function() {
    it('should create an instance of LogonState', function() {
      // uncomment below and update the code to test LogonState
      //var instane = new IntegratorApi.LogonState();
      //expect(instance).to.be.a(IntegratorApi.LogonState);
    });
