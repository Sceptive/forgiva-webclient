...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostUserMetadataBygroupRequest();
  });
  ...
  describe('PostUserMetadataBygroupRequest', function() {
    it('should create an instance of PostUserMetadataBygroupRequest', function() {
      // uncomment below and update the code to test PostUserMetadataBygroupRequest
      //var instane = new IntegratorApi.PostUserMetadataBygroupRequest();
      //expect(instance).to.be.a(IntegratorApi.PostUserMetadataBygroupRequest);
    });
