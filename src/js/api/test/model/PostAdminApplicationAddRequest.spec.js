...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminApplicationAddRequest();
  });
  ...
  describe('PostAdminApplicationAddRequest', function() {
    it('should create an instance of PostAdminApplicationAddRequest', function() {
      // uncomment below and update the code to test PostAdminApplicationAddRequest
      //var instane = new IntegratorApi.PostAdminApplicationAddRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminApplicationAddRequest);
    });
