...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostLogin2faRequest();
  });
  ...
  describe('PostLogin2faRequest', function() {
    it('should create an instance of PostLogin2faRequest', function() {
      // uncomment below and update the code to test PostLogin2faRequest
      //var instane = new IntegratorApi.PostLogin2faRequest();
      //expect(instance).to.be.a(IntegratorApi.PostLogin2faRequest);
    });

    it('should have the property twoFACode (base name: "twoFACode")', function() {
      // uncomment below and update the code to test the property twoFACode
      //var instane = new IntegratorApi.PostLogin2faRequest();
