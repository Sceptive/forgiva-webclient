...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminHostsRequest();
  });
  ...
  describe('PostAdminHostsRequest', function() {
    it('should create an instance of PostAdminHostsRequest', function() {
      // uncomment below and update the code to test PostAdminHostsRequest
      //var instane = new IntegratorApi.PostAdminHostsRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminHostsRequest);
    });
