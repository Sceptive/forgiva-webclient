...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUsergroupsRequest();
  });
  ...
  describe('PostAdminUsergroupsRequest', function() {
    it('should create an instance of PostAdminUsergroupsRequest', function() {
      // uncomment below and update the code to test PostAdminUsergroupsRequest
      //var instane = new IntegratorApi.PostAdminUsergroupsRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUsergroupsRequest);
    });
