...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminHostRemoveRequest();
  });
  ...
  describe('PostAdminHostRemoveRequest', function() {
    it('should create an instance of PostAdminHostRemoveRequest', function() {
      // uncomment below and update the code to test PostAdminHostRemoveRequest
      //var instane = new IntegratorApi.PostAdminHostRemoveRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminHostRemoveRequest);
    });
