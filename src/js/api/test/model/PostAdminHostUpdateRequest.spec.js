...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminHostUpdateRequest();
  });
  ...
  describe('PostAdminHostUpdateRequest', function() {
    it('should create an instance of PostAdminHostUpdateRequest', function() {
      // uncomment below and update the code to test PostAdminHostUpdateRequest
      //var instane = new IntegratorApi.PostAdminHostUpdateRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminHostUpdateRequest);
    });
