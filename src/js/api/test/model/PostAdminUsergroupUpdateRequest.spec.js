...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUsergroupUpdateRequest();
  });
  ...
  describe('PostAdminUsergroupUpdateRequest', function() {
    it('should create an instance of PostAdminUsergroupUpdateRequest', function() {
      // uncomment below and update the code to test PostAdminUsergroupUpdateRequest
      //var instane = new IntegratorApi.PostAdminUsergroupUpdateRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUsergroupUpdateRequest);
    });
