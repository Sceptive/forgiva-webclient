...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUsergroupRemoveRequest();
  });
  ...
  describe('PostAdminUsergroupRemoveRequest', function() {
    it('should create an instance of PostAdminUsergroupRemoveRequest', function() {
      // uncomment below and update the code to test PostAdminUsergroupRemoveRequest
      //var instane = new IntegratorApi.PostAdminUsergroupRemoveRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUsergroupRemoveRequest);
    });
