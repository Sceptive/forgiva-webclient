...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostUserMetadataGroupRemoveRequest();
  });
  ...
  describe('PostUserMetadataGroupRemoveRequest', function() {
    it('should create an instance of PostUserMetadataGroupRemoveRequest', function() {
      // uncomment below and update the code to test PostUserMetadataGroupRemoveRequest
      //var instane = new IntegratorApi.PostUserMetadataGroupRemoveRequest();
      //expect(instance).to.be.a(IntegratorApi.PostUserMetadataGroupRemoveRequest);
    });
