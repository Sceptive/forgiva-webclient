...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminResourceusageResponseCpuUsageByDay();
  });
  ...
  describe('PostAdminResourceusageResponseCpuUsageByDay', function() {
    it('should create an instance of PostAdminResourceusageResponseCpuUsageByDay', function() {
      // uncomment below and update the code to test PostAdminResourceusageResponseCpuUsageByDay
      //var instane = new IntegratorApi.PostAdminResourceusageResponseCpuUsageByDay();
      //expect(instance).to.be.a(IntegratorApi.PostAdminResourceusageResponseCpuUsageByDay);
    });
