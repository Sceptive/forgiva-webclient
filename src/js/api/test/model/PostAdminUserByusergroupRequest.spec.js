...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUserByusergroupRequest();
  });
  ...
  describe('PostAdminUserByusergroupRequest', function() {
    it('should create an instance of PostAdminUserByusergroupRequest', function() {
      // uncomment below and update the code to test PostAdminUserByusergroupRequest
      //var instane = new IntegratorApi.PostAdminUserByusergroupRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUserByusergroupRequest);
    });
