...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUserRemoveRequest();
  });
  ...
  describe('PostAdminUserRemoveRequest', function() {
    it('should create an instance of PostAdminUserRemoveRequest', function() {
      // uncomment below and update the code to test PostAdminUserRemoveRequest
      //var instane = new IntegratorApi.PostAdminUserRemoveRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUserRemoveRequest);
    });
