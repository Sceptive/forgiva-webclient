...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUsergroupsResponse();
  });
  ...
  describe('PostAdminUsergroupsResponse', function() {
    it('should create an instance of PostAdminUsergroupsResponse', function() {
      // uncomment below and update the code to test PostAdminUsergroupsResponse
      //var instane = new IntegratorApi.PostAdminUsergroupsResponse();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUsergroupsResponse);
    });
