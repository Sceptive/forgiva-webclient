...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostUserMetadataHostRequest();
  });
  ...
  describe('PostUserMetadataHostRequest', function() {
    it('should create an instance of PostUserMetadataHostRequest', function() {
      // uncomment below and update the code to test PostUserMetadataHostRequest
      //var instane = new IntegratorApi.PostUserMetadataHostRequest();
      //expect(instance).to.be.a(IntegratorApi.PostUserMetadataHostRequest);
    });
