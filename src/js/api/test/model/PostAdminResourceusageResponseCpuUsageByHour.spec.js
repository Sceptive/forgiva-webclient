...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminResourceusageResponseCpuUsageByHour();
  });
  ...
  describe('PostAdminResourceusageResponseCpuUsageByHour', function() {
    it('should create an instance of PostAdminResourceusageResponseCpuUsageByHour', function() {
      // uncomment below and update the code to test PostAdminResourceusageResponseCpuUsageByHour
      //var instane = new IntegratorApi.PostAdminResourceusageResponseCpuUsageByHour();
      //expect(instance).to.be.a(IntegratorApi.PostAdminResourceusageResponseCpuUsageByHour);
    });
