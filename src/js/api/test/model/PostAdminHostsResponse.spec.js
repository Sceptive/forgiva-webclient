...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminHostsResponse();
  });
  ...
  describe('PostAdminHostsResponse', function() {
    it('should create an instance of PostAdminHostsResponse', function() {
      // uncomment below and update the code to test PostAdminHostsResponse
      //var instane = new IntegratorApi.PostAdminHostsResponse();
      //expect(instance).to.be.a(IntegratorApi.PostAdminHostsResponse);
    });
