...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUserUpdateRequest();
  });
  ...
  describe('PostAdminUserUpdateRequest', function() {
    it('should create an instance of PostAdminUserUpdateRequest', function() {
      // uncomment below and update the code to test PostAdminUserUpdateRequest
      //var instane = new IntegratorApi.PostAdminUserUpdateRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUserUpdateRequest);
    });
