...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostLogin2faResponse();
  });
  ...
  describe('PostLogin2faResponse', function() {
    it('should create an instance of PostLogin2faResponse', function() {
      // uncomment below and update the code to test PostLogin2faResponse
      //var instane = new IntegratorApi.PostLogin2faResponse();
      //expect(instance).to.be.a(IntegratorApi.PostLogin2faResponse);
    });
