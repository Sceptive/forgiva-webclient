...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminUserAddRequest();
  });
  ...
  describe('PostAdminUserAddRequest', function() {
    it('should create an instance of PostAdminUserAddRequest', function() {
      // uncomment below and update the code to test PostAdminUserAddRequest
      //var instane = new IntegratorApi.PostAdminUserAddRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminUserAddRequest);
    });
