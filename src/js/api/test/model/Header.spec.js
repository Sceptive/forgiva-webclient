...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.Header();
  });
  ...
  describe('Header', function() {
    it('should create an instance of Header', function() {
      ...
      //var instane = new IntegratorApi.Header();
      //expect(instance).to.be.a(IntegratorApi.Header);
    });
    ...
    it('should have the property clientAgent (base name: "clientAgent")', function() {
      // uncomment below and update the code to test the property clientAgent
      //var instane = new IntegratorApi.Header();
      //expect(instance).to.be();
    });
