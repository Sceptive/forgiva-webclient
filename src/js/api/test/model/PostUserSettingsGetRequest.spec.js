...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostUserSettingsGetRequest();
  });
  ...
  describe('PostUserSettingsGetRequest', function() {
    it('should create an instance of PostUserSettingsGetRequest', function() {
      // uncomment below and update the code to test PostUserSettingsGetRequest
      //var instane = new IntegratorApi.PostUserSettingsGetRequest();
      //expect(instance).to.be.a(IntegratorApi.PostUserSettingsGetRequest);
    });
