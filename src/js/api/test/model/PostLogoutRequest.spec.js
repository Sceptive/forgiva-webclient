...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostLogoutRequest();
  });
  ...
  describe('PostLogoutRequest', function() {
    it('should create an instance of PostLogoutRequest', function() {
      // uncomment below and update the code to test PostLogoutRequest
      //var instane = new IntegratorApi.PostLogoutRequest();
      //expect(instance).to.be.a(IntegratorApi.PostLogoutRequest);
    });
