...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminHostAddRequest();
  });
  ...
  describe('PostAdminHostAddRequest', function() {
    it('should create an instance of PostAdminHostAddRequest', function() {
      // uncomment below and update the code to test PostAdminHostAddRequest
      //var instane = new IntegratorApi.PostAdminHostAddRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminHostAddRequest);
    });
