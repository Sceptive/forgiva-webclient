...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IntegratorApi.PostAdminApplicationUpdateRequest();
  });
  ...
  describe('PostAdminApplicationUpdateRequest', function() {
    it('should create an instance of PostAdminApplicationUpdateRequest', function() {
      // uncomment below and update the code to test PostAdminApplicationUpdateRequest
      //var instane = new IntegratorApi.PostAdminApplicationUpdateRequest();
      //expect(instance).to.be.a(IntegratorApi.PostAdminApplicationUpdateRequest);
    });
